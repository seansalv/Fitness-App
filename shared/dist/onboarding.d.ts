export type Motivation = 'strength' | 'discipline' | 'confidence' | 'legacy' | 'appearance' | 'stress' | 'social' | 'enjoyment';
export type FocusArea = 'full' | 'chest' | 'back' | 'arms' | 'shoulders' | 'abs' | 'legs' | 'glutes';
...
export type OnboardingAnswerValue = string | string[] | WeightAnswer | HeightAnswer | FrequencyAnswer | ScheduleAnswer | QuestPayload | Record<string, unknown>;
